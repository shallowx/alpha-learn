...
public class ClassTests {
    ...
    public void test3() throws ClassNotFoundException {
        Class<?> cf1 = Class.forName("com.alpha.learn.jdk25.ClassTests$TestSubClass", false, ClassLoader.getSystemClassLoader());
        log.info("cf1: {}", cf1);
        ...
        log.info("-----------spilt-----------");
        Class<?> cf2 = Class.forName("com.alpha.learn.jdk25.ClassTests$TestSubClass");
        log.info("cf2: {}", cf2);

        Class<?> cf3 = Class.forName("com.alpha.learn.jdk25.ClassTests$TestSubClass");
    }
